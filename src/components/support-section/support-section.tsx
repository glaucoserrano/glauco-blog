    ...
    return(
        ...
        >
            <div className="
                ...
                bg-[url('/background-features.svg')]
                bg-cover bg-no-repeat bg-center opacity-90"
            />

            <div className=" container flex 
                flex-col items-center gap-12 relative"
            >
                <h2 className="
                    font-sans
                ...
                >
                    ...
                    <div className="
                        ...
                        gap-2 rounded-lg p-6 md:p-12 bg-blue-400"
                    >
                        <div className="
                            flex h-12 w-12 items-center justify-center 
                            bg-blue-300 mb-4"
                        >
                            <PaintbrushVertical className="
                                h-6 w-6 text-white"
                            />
                        </div>
                    ...
                    <div className="
                        flex flex-col text-left 
                        gap-2 rounded-lg p-6 md:p-12 bg-cyan-300"
                    >
                        <div className="
                            flex h-12 w-12 items-center justify-center 
                            bg-cyan-200 mb-4"
